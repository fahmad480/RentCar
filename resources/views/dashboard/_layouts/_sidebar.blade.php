                    ...
                    <li>
                        ...
                        <div class="overflow-hidden" :class="(selected === 'Rent') ? 'block' :'hidden'">
                            <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                ...
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white {{ ($menu === 'rentReturn') ? '!text-white' : '' }}"
                                        href="{{ route('rent.return') }}">Return a Car</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
