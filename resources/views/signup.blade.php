                ...
                <div class="hidden w-full xl:block xl:w-1/2">
                    <div class="py-17.5 px-26 text-center">
                        ...
                        <p class="font-medium 2xl:px-20">
                            Rent a car has never been easier than this.
                        </p>
                    ...
                    <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                        ...
                        <form>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    <textarea type="text" placeholder="Enter your address" name="address" id="address"
                            ...
                            <div class="mb-6">
                                <label class="mb-2.5 block font-medium text-black dark:text-white">Driver's
                                    License</label>
                                <div class="relative">
                                    <input type="text" placeholder="Enter your driver's license" name="driver_license"
                                        id="driver_license"
                                        class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                            ...
                            <div class="mt-6 text-center">
                                <p class="font-medium">
                                    ...
                                    <a href="{{ route('auth.signin') }}" class="text-primary">Sign in</a>
                                </p>
                            </div>
                        </form>
                    </div>
